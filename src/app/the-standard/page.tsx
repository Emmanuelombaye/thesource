...
const standards = [
  ...
  },
  {
    ...
    title: "Dispatch",
    body: [
      "Prepared and dispatched within 24 to 48 hours, sealed and tracked. The vial that arrives is the vial that was tested.",
      "Orders leave the house within 24 to 48 hours, shipped sealed and tracked from release to delivery. Nothing is opened or repackaged in transit.",
    ],
